...
Dapatkan buku yang tersedia (stock > 0)
...
Dapatkan semua record peminjaman
...
Dapatkan peminjaman yang terlambat

GET

/api/borrowings/stats
...
Import Collection: Import file JSON collection Postman yang disediakan.

Set Environment: Atur baseUrl ke http://localhost:3000.
